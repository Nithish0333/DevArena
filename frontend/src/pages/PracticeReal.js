...
int main() {
  ...
  return (
    <Container className="py-5">
      <div className="mb-4">
        <h1 className="text-center mb-4">Real Code Editor</h1>
        <p className="text-center text-muted">
          Write and execute real code! Like W3Schools, but better!
        </p>
      </div>
                  ...
                  <div>
                    {output.split('\n').map((line, index) => (
                      <div key={index} style={{ 
                        marginBottom: '2px',
                        padding: '2px 0',
                        borderBottom: line.includes('ERROR') ? '1px solid #ff6b6b' : 'none',
                        backgroundColor: line.includes('ERROR') ? 'rgba(255, 107, 107, 0.1)' : 'transparent',
